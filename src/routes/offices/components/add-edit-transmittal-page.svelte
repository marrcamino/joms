<script lang="ts">
  ...
  import { getTransmittalContext } from "./transmittal-dialog/context.svelte";
  import EmptyTransmittal from "./transmittal-dialog/empty-transmittal.svelte";
  import SecondDialog from "./transmittal-dialog/second-dialog.svelte";
