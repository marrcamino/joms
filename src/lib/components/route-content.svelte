  ...
  <div class="flex-1">
    ...
    {:else}
      <ScrollArea
        ...
        class="relative px-2 transition-[width] duration-200 ease-linear
        {sidebar.open
          ? 'w-[calc(100dvw_-_var(--sidebar-width))] print:w-full'
          : 'w-[calc(100dvw_-_var(--sidebar-width-icon))] print:w-full'}"
      >
        {@render children()}
      </ScrollArea>
    {/if}
