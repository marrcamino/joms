...
$routes = [
  'GET' => [
    ...
    '/api/employee/contract/check-pds-overlaps' => 'htdocs/api/employee/contract/check-pds-overlaps.php',
    ...
    '/api/transmittal-item/get-group-counts' => 'htdocs/api/transmittal-item/get-group-counts.php',
    '/api/transmittal-item' => 'htdocs/api/transmittal-item/get.php',
  ...
  'PATCH' => [
    ...
    '/api/contract/update-patch' => 'htdocs/api/contract/update-patch.php',
